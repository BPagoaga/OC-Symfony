...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a69daf7656efa28e7c6089390512364ac88f7557c95521960b7cba7452dd64d0');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Purge\OCPurgeAdverts A OC\PlatformBundle\Purge\OCPurgeAdverts instance.
     */
    protected function getOcPlatform_Purger_AdvertService()
    {
        return $this->services['oc_platform.purger.advert'] = new \OC\PlatformBundle\Purge\OCPurgeAdverts($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5bae1c74a67cb7.77341039')), true);
